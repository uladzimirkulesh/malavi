...
<section class="wp-block-group alignwide section section--contacts-page" id="section-contacts-page">
	...
	<div class="wp-block-columns" style="margin-bottom:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-column" style="flex-basis:75%">
			...
			<h2 class="wp-block-heading has-xxxxxxx-large-font-size"><?php echo esc_html_x( 'Contacts', 'Title for "Contacts Page" pattern', 'silence' ); ?></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:column -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<p class="has-xxx-large-font-size" style="margin-bottom:var(--wp--preset--spacing--50)"><?php echo esc_html_x( 'If you’re interested in working with us, or collaborating on a project, we’d love to hear from you.', 'Text for "Contacts Page" pattern', 'silence' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--20)">
					...
					<div class="wp-block-column" style="flex-basis:50%">
						<!-- wp:heading {"level":6} -->
						<h6 class="wp-block-heading"><?php echo esc_html_x( 'Address', 'Small title for "Contacts Page" pattern', 'silence' ); ?></h6>
						<!-- /wp:heading -->
					...
					<div class="wp-block-column" style="flex-basis:50%">
						<!-- wp:heading {"level":6} -->
						<h6 class="wp-block-heading"><?php echo esc_html_x( 'Work hours', 'Small title for "Contacts Page" pattern', 'silence' ); ?></h6>
						<!-- /wp:heading -->
			...
			<div class="wp-block-group">
				...
				<h6 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html_x( 'Get in Touch', 'Small title for "Contacts Page" pattern', 'silence' ); ?></h6>
				<!-- /wp:heading -->
			...
			<div class="wp-block-group">
				...
				<!-- wp:heading {"level":6,"style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
				<h6 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--20)"><?php echo esc_html_x( 'Social networks', 'Small title for "Contacts Page" pattern', 'silence' ); ?></h6>
				<!-- /wp:heading -->
				...
				<div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--10)">
					...
					<div class="wp-block-column" style="flex-basis:50%">
						<!-- wp:paragraph -->
						<p><a rel="noreferrer noopener" href="#" target="_blank"><?php echo esc_html_x( 'LinkedIn', 'Text for LinkedIn link for "Contact Page" pattern', 'silence' ); ?></a><br><a rel="noreferrer noopener" href="#" target="_blank"><?php echo esc_html_x( 'Facebook', 'Text for Facebook link for "Contact Page" pattern', 'silence' ); ?></a></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:column -->
