	...
	<div class="wp-block-columns" style="margin-bottom:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-column" style="flex-basis:75%">
			...
			echo wp_kses_post(
				...
				__( 'A few words about <br>development <br>process', 'malavi' )
			);
			?></h1>
			<!-- /wp:heading -->
		</div>
		...
		<div class="wp-block-column" style="padding-top:var(--wp--preset--spacing--20);flex-basis:25%">
			...
			<p class="page-header__small-note has-contrast-secondary-text-color has-text-color" style="line-height:1.5"><?php echo esc_html_x( 'See how software is developed and how it can help your business compete. Discover software development innovations and technologies.', 'Small text for "Page header" pattern', 'malavi' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
