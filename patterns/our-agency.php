...
<section class="wp-block-group alignwide section section--our-agency" id="section-our-agency">
	...
	<div class="wp-block-columns" style="margin-bottom:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-column" style="flex-basis:75%">
			...
			echo wp_kses_post(
				...
				__( 'We are - <br>Kalipso Design', 'malavi' )
			);
			?></h1>
			<!-- /wp:heading -->
		</div>
	...
	<div class="wp-block-columns" style="margin-bottom:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-column" style="flex-basis:50%">
			<!-- wp:heading {"level":6} -->
			<h6 class="wp-block-heading"><?php echo esc_html_x( 'Our agency', 'Small title for "Our agency" pattern', 'malavi' ); ?></h6>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="flex-basis:50%">
			...
			<p class="has-contrast-color has-text-color has-large-font-size"><?php echo esc_html_x( 'From the moment our company was founded, we have helped our clients find exceptional solutions for their businesses, creating memorable brands and digital products.', 'Text for "Our agency" pattern', 'malavi' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
