 ...
 */
?>
<!-- wp:group {"tagName":"section","align":"full","className":"pattern-who-we-are","layout":{"type":"default"}} -->
<section class="wp-block-group alignfull pattern-who-we-are">
	<!-- wp:group {"className":"pattern-who-we-are--container","layout":{"type":"default"}} -->
	<div class="wp-block-group pattern-who-we-are--container">
		...
		<div class="wp-block-columns" style="margin-bottom:var(--wp--preset--spacing--50)">
			...
			<div class="wp-block-column" style="flex-basis:75%">
				<!-- wp:heading {"textAlign":"left","level":1,"fontSize":"xxxxxxx-large"} -->
			...
			<div class="wp-block-column" style="flex-basis:25%">
				<!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30"}},"typography":{"lineHeight":"1.5"}},"textColor":"contrast-secondary-text","className":"section-small-text"} -->
				<p class="section-small-text has-contrast-secondary-text-color has-text-color" style="padding-top:var(--wp--preset--spacing--30);line-height:1.5"><?php echo esc_html_x( '[ We are obsessed with creativity — challenging what is, while defining what comes next. ]', 'Small text for "Who we are" pattern', 'silence' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
		</div>
